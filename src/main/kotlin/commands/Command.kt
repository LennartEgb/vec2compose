...
/**
 * Commands for path data for vector formats found
 * [here](https://www.w3.org/TR/SVG/paths.html#PathData)
 */
internal sealed interface Command {
  companion object {
    val validCommands: CharArray =
        charArrayOf('A', 'C', 'H', 'L', 'M', 'Q', 'S', 'T', 'V', 'Z')
