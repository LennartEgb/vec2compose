...
data class SVG(
    @field:JacksonXmlProperty(localName = "width") val width: String,
    @field:JacksonXmlProperty(localName = "height") val height: String,
    @field:JacksonXmlProperty(localName = "viewBox") val viewBox: String? = null,
