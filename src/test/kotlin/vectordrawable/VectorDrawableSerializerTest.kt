                            ...
                            path =
                                listOf(
                                    ...
                                    VectorDrawable.Path(
                                        ...
                                        fillColor = "#FF000000",
                                        pathData =
                                            "M13,12.5h2L11,20v-5.5H9L11.93,9H7v11.67C7,21.4 7.6,22 8.33,22h7.33c0.74,0 1.34,-0.6 1.34,-1.33V9h-4v3.5z",
                                        fillType = "nonZero",
                                    )))),
            ),
        actual = serializer.deserialize(vector).getOrThrow())
                        ...
                        VectorDrawable.Group(
                            ...
                            group =
                                listOf(
                                    ...
                                    VectorDrawable.Group(
                                        name = "parent.second",
                                        path = listOf(VectorDrawable.Path(pathData = "M13,12.5")))),
                        )),
            ),
        actual = serializer.deserialize(vector).getOrThrow())
  }
