...
internal class SVGDeserializerTest {
  ...
  fun `deserialize valid SVG file`() {
    ...
    assertEquals(expected = Result.success(expected), actual = deserializer.deserialize(content))
  }
                            ...
                            g =
                                listOf(
                                    SVG.Group(
                                        ...
                                        path =
                                            listOf(
                                                SVG.Path(id = "first", pathData = "M48.42,78.11"))),
                                    SVG.Group(
                                        name = "head",
                                        path =
                                            listOf(
                                                SVG.Path(
                                                    id = "second", pathData = "M48.42,78.11"))))))),
