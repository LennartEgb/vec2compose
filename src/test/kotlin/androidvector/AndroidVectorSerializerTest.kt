...
internal class AndroidVectorSerializerTest {

    private val serializer = AndroidVectorSerializer(TestObjectMapper)

    @Test
    fun `serialize valid android vector file returns serialized AndroidVector`() {
        val vector = XML(
            content = """
