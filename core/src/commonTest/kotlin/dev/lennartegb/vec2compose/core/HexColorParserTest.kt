...
class HexColorParserTest {
    ...
    fun whiteColorToFillColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0xFF, green = 0xFF, blue = 0xFF, alpha = 0xFF),
    ...
    fun redColorToFillColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0xFF, green = 0x00, blue = 0x00, alpha = 0xFF),
    ...
    fun greenColorToFillColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x00, green = 0xFF, blue = 0x00, alpha = 0xFF),
    ...
    fun blueColorToFillColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x00, green = 0x00, blue = 0xFF, alpha = 0xFF),
    ...
    fun parseEightCharHexBlackColorWithAlphaToFillColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x00, green = 0x00, blue = 0xFF, alpha = 0x33),
    ...
    fun parseRgbaColor() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x01, green = 0x02, blue = 0x03, alpha = 0x04),
    ...
    fun parseRgbaColorWithSixElements() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x01, green = 0x02, blue = 0x03, alpha = 0xff),
    ...
    fun parseRgbaColorWithFourElements() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x11, green = 0x22, blue = 0x33, alpha = 0x44),
    ...
    fun parseRgbaColorWithThreeElements() {
        assertEquals(
            expected = ImageVector.Path.FillColor(red = 0x11, green = 0x22, blue = 0x33, alpha = 0xff),
